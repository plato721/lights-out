...
/***/ function(module, exports, __webpack_require__) {
	...
	Board.prototype.equals = function (other) {
	  for (var i = 0; i < this.width; i++) {
	    for (var j = 0; j < this.width; j++) {
	      if (this.lightGrid[i][j].lit !== other.lightGrid[i][j].lit) {
	        return false;
	      }
	    }
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	Light.prototype.bindClick = function () {
	  this.element.find('.light').on('click', (function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.level1 = __webpack_require__(11);
	exports.level2 = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (x, y, board) {
	  ...
	  function rawNeighborCoords(x, y) {
	    return [relativeCoords.above([x, y]), relativeCoords.below([x, y]), relativeCoords.right([x, y]), relativeCoords.left([x, y])];
	  }

	  function onBoard(x, y) {
	    return !(offBoardLeft(x, y) || offBoardRight(x, y) || offBoardAbove(x, y) || offBoardBelow(x, y));
	  }
...
/***/ function(module, exports) {
	...
	module.exports = {
	  below: function below(coords) {
	    return [coords[0], coords[1] + 1];
	  },

	  above: function above(coords) {
	    return [coords[0], coords[1] - 1];
	  },

	  right: function right(coords) {

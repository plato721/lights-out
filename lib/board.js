...
Board.prototype.onBoard = function(x,y){
  return !(this.offBoardLeft || this.offBoardRight ||
           this.offBoardAbove || this.offBoardBelow)
};
...
Board.prototype.rawNeighborCoords = function(x,y) {
  return [coordsAbove([x,y]), coordsRight([x,y]),
    coordsBelow([x,y]), coordsLeft([x,y])];
};
